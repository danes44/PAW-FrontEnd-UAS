    ...
    <div id="cart" class="px-5 py-3">
      ...
      <b-form>
        <b-row class="py-5">
          ...
          <!--            card Location-->
          <b-col xl="4" md="12" sm="12" cols="12" class="mb-4">
            <b-row class="px-2">
              <b-col xl="12" md="6" sm="12" cols="12" class="mb-4 mx-0">
                <b-card class="border-0 shadow rounded px-4 py-3">
                  <h4 class="py-2 pb-3"><b>Location</b></h4>

                  <b-form-row>
                    <b-col xl="6" md="12" sm="6" cols="12" class="">
              ...
              <b-col xl="12" md="6" sm="12" cols="12" class="mb-4 mx-0">
                <b-card class="border-0 shadow rounded px-4 py-3">
                  ...
                  <div v-if="selectedRadio == 'visa'">
                    ...
                    <b-form-row class="pt-2">
                      <b-col xl="6" md="12" sm="12" cols="12" class="mb-2 pl-0">
                        <b-input-group class="mb-3">
                          <b-input-group-prepend is-text class="text">
                            <b-icon icon="credit-card-fill"></b-icon>
                          </b-input-group-prepend>
                      ...
                      <b-col xl="6" md="12" sm="12" cols="12" class="mb-2 pr-0">
                        <b-input-group class="mb-3">
                          <b-form-datepicker
                            id="datepicker"
                            v-model="dateExpired"
...
<!--      modal receipt-->
      <b-modal id="modalPayment"
               modal-class="border-0 rounded"
               hide-header
               hide-footer
      >
        <div class="px-4">
          <h3 class="py-5 text-center"><b>Payment Receipt</b></h3>
          <b-row class="pt-2 border-0">
            <b-col cols="6">
              <p><b>Order ID </b></p>
            </b-col>
          ...
          <b-row class="pt-5 pb-3 float-right">
